...
//$_SESSION["_HOST"] = "13.84.180.63";
	...
	$_SESSION["_CONTRASENA_CONEXION"]	= "%erpemi%" ;
	...
	/*Configuracion base de datos Informix*/
	$_SESSION['_HOST_INFORMIX'] = '172.16.3.77';
	$_SESSION['_DATABASE_INFORMIX'] = 'emi2020_p';
	$_SESSION['_USER_INFORMIX'] = 'tester';
	$_SESSION['_PASS_INFORMIX'] = 't3st3r';
	$_SESSION['_SERVER_INFORMIX'] = 'sai1';
	/****************************************/
