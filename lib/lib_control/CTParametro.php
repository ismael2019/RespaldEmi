...
class CTParametro{
    ...
    function aplicaFiltroRapido() {
        ...
        if ($this->getParametro('bottom_filtro_value') != '' && $this->getParametro('bottom_filtro_fields')) {
            $fields = str_replace('#', ',', $this->getParametro('bottom_filtro_fields'));
            $fields = explode(',', $fields);

            $value = $this->getParametro('bottom_filtro_value');
            if ($this->getParametro('bottom_filter_fields')) {
                $query .= " or (".$fields[0]."::varchar ILIKE ''%".$value."%'')";
            }else{
                $query .= "(".$fields[0]."::varchar ILIKE ''%".$value."%'')";
            }
        ...
        if(($this->getParametro('bottom_filter_fields') || $this->getParametro('bottom_filtro_fields')) && $this->getParametro('bottom_filtro_value') != '' ) {
            $this->addFiltro("($query)");
        }
    }
